    ...
    <main>
      <section className="px-6 py-20 sm:px-8 sm:py-28 lg:px-12">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-4xl font-normal leading-tight tracking-[-0.65px] text-[#ffffff] sm:text-5xl lg:text-[60px] lg:leading-[64px]">
            Your own ears cannot tell.
            <br />
            <span className="text-[#00d992]">CatchAm can.</span>
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-[#bdbdbd] sm:text-lg">
