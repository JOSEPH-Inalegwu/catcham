      ...
      <div className="relative z-10 w-full max-w-[360px]">
        ...
        <div className="mb-10 text-center flex flex-col items-center">
          ...
          {/* <p className="mt-2 text-sm text-[#a0a0a0]">
            Sign in to access your enterprise dashboard and forensic reports.
          </p> */}
        </div>

        <div className="space-y-4">
          <button className="flex w-full items-center justify-center gap-3 rounded-[6px] border border-[#3d3a39] bg-[#1a1a1a] px-4 py-3 text-sm font-semibold text-[#ffffff] transition-colors hover:bg-[#2a2a2a] hover:border-[#5a5a5a]">
        ...
        <div className="mt-8 text-center text-sm text-[#a0a0a0]">
          ...
          <Link href="/auth/signup" className="text-[#ffffff] hover:underline">
            Sign up
          </Link>
          {" "}or{" "}
